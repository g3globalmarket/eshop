...
model QPayWebhookEvent {
  ...
  forwardStatus String  @default("pending") // pending, forwarded, failed, retry_pending
  lastError    String?
...
model QPayPaymentSession {
  ...
  payload       Json      // Full sessionData (cart, sellers, totalAmount, etc.)
  ...
  ebarimtRaw          Json?     // Full response from QPay (optional, for audit)
  ebarimtLastError    String?   // Last error message if creation failed
  ebarimtCreatedAt    DateTime? // When Ebarimt was successfully created
